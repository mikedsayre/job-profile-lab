      ...
      <footer className="w-full py-6 text-amber-400 text-sm text-center border-t border-orange-800 mt-auto">
        <div className="flex items-center justify-center">
          <img
            ...
            aria-hidden="true"
          />
          &copy; {new Date().getFullYear()} {APP_NAME} <a href={BYLINE_LINK} target="_blank" rel="noopener noreferrer" className="text-orange-400 hover:text-orange-300 transition-colors duration-200 ml-1">{BYLINE}</a>. All rights reserved.
        </div>
      </footer>
    </div>
  );
